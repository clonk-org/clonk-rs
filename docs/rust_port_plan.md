...
## Parity Gaps
- Startup/menu flow needs full HUD parity, content coverage, save/load, scenario metadata, and production-ready UI polish.
...
1. Standalone Rust client parity
   ...
   - [ ] Promote Rust UI/input/audio to production fidelity (HUD, SFX, save/load, scripting hooks).
