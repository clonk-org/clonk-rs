...
**Problem:** Command stack covers MoveTo/Follow/Enter/Exit/Build/Attack/Acquire/Buy/Energy + Grab/UnGrab/Throw/Wait/Jump/Chop/Dig/Home/Put/Drop; Construct/Transfer/Context/Sell/Call/Take/Take2 still unported so many C++ behaviours remain unavailable
...
2. Implement remaining command types (Construct/Transfer/Context/Sell/Call/Take/Take2) and associated movement heuristics
