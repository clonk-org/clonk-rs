...
- ⚠️ **Weather & Sky** (C4Weather.cpp, C4Sky.cpp 🔗 Partial)
  - ✅ Time-of-day driven sky gradient generated by `EnvironmentSettings::resolved_sky_color`
  - ❌ Dynamic weather (rain, snow, wind, lightning)
  - ❌ Sky assets (stars, celestial bodies)
  - ❌ Gamma/day-night lighting effects
