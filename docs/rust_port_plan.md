...
- **Current State:** Build compiles; workspace tests green; Build/Exit/Grab/UnGrab/Throw/Wait/Chop commands implemented in command stack
...
| **AI Commands** | ⚠️ Partial | MoveTo/Follow/Enter/Exit/Build/Attack/Wait/Retry/Throw/Chop + Acquire + Grab/UnGrab handle loose/container/cross-container pickups; Buy spawns base purchases and targeted hand-offs; command persistence landed; remaining commands (Jump/Get/Put/Drop/Dig/Activate/PushTo/Construct/Transfer/Context/Sell/Home/Call/Take/Take2) still pending | TBD |
