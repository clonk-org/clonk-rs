...
- **Current State:** Build compiles; workspace tests green; Build/Exit/Grab/UnGrab/Throw/Wait commands implemented in command stack
...
2. Implement remaining command types (Chop/Jump/Get/Put/Drop/Dig/Activate/PushTo/Construct/Transfer/Context/Sell/Home/Call/Take/Take2) and associated movement heuristics
