...
- Persistent input bindings plus networking/editor toolchain integration remain outstanding; audio/video configs (enablement, volumes, channels, window state) now flow through the Rust runtime.
