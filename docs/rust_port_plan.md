...
- **P0 BLOCKERS:** AI command system still partial (Acquire/Buy persistence + AddCommand lifecycle audit outstanding)
- **Scenario Discovery:** ✅ Official content repo wired; menu now lists full scenario catalog
- **Current State:** Build compiles; workspace tests green; Build/Construct/Exit/Grab/UnGrab/Throw/Wait/Jump/Chop/Get/Sell/Context/Take/Take2 commands implemented in command stack
