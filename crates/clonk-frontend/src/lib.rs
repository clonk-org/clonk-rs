...
mod tests {
    ...
    fn real_tutorial_seven_acid_rain_matches_cpp_animated_pxs_sequence() {
        ...
        // FXP1 has no `[Physical]` section, so C4PhysicalInfo::Default leaves
        // Float at zero. DFA_FLOAT clamps Movement's StartCall velocity before
        // ExecMovement, keeping the cloud at its launch point
        // (C4InfoCore.cpp:234-242; C4Object.cpp:1047-1093,5291-5310).
        // Frames 1-3 are unchanged; the sequence parts company from frame 4,
        // where Glint's first material-table probe used to alias slot 0 and
        // spend synchronized Random() draws the oracle never spends
        // (clonk-org/clonk-rs#1066).
        let expected_frames = [
            (0, 0xdbdc_9dc5, 0, None),
            (3, 0x7d66_e2bc, 21, Some((57, 1, 212, 7))),
            (3, 0xc0b7_6355, 24, Some((58, 8, 212, 15))),
            (6, 0x7978_ee9d, 42, Some((12, 1, 213, 22))),
            (6, 0x8ef4_5b34, 45, Some((13, 8, 214, 29))),
            (9, 0xd7bd_e285, 64, Some((13, 1, 215, 37))),
            (9, 0x756a_b99c, 67, Some((14, 8, 216, 44))),
            (11, 0xe933_967d, 76, Some((15, 1, 217, 50))),
            (11, 0x8c3c_a5f8, 79, Some((16, 8, 218, 57))),
            (14, 0x2bfd_44ec, 99, Some((17, 1, 220, 64))),
        ];
        let expected_first_particle = [
            [3_775_195, 552_373, 39_643, 486_837],
            [3_824_097, 1_033_657, 48_902, 481_284],
            [3_882_437, 1_511_739, 58_340, 478_082],
            [3_942_973, 1_989_433, 60_536, 477_694],
            [4_012_449, 2_458_135, 69_476, 468_702],
            [4_085_199, 2_919_792, 72_750, 461_657],
            [4_158_614, 3_371_694, 73_415, 451_902],
            [4_234_758, 3_819_851, 76_144, 448_157],
            [4_318_409, 4_259_665, 83_651, 439_814],
        ];
