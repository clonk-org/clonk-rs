...
pub(crate) const MENU_SEPARATOR_HEIGHT: i32 = 8;
pub(crate) const FONT_SIZE: f32 = 13.0;
pub(crate) const SMALL_FONT_SIZE: f32 = 11.0;

pub(crate) const WINDOW_BACKGROUND: Color = Color::opaque(0xd4, 0xd0, 0xc8);
pub(crate) const CONTROL_BACKGROUND: Color = Color::opaque(0xff, 0xff, 0xff);
pub(crate) const CONTROL_TEXT: Color = Color::opaque(0x10, 0x10, 0x10);
pub(crate) const DISABLED_TEXT: Color = Color::opaque(0x78, 0x78, 0x78);
pub(crate) const SELECTED_BACKGROUND: Color = Color::opaque(0x31, 0x6a, 0xc5);
pub(crate) const SELECTED_TEXT: Color = Color::opaque(0xff, 0xff, 0xff);
pub(crate) const LIGHT_EDGE: Color = Color::opaque(0xff, 0xff, 0xff);
pub(crate) const DARK_EDGE: Color = Color::opaque(0x60, 0x60, 0x60);
pub(crate) const MID_EDGE: Color = Color::opaque(0x9a, 0x9a, 0x9a);

/// Whether `point` lands inside `rect`, right and bottom edges exclusive.
pub(crate) fn contains(rect: IntRect, point: GuiPoint) -> bool {
...
pub(crate) fn gui_rect(rect: IntRect) -> GuiRect {
    GuiRect::new(
        rect.x as f32,
        rect.y as f32,
        rect.w.max(0) as f32,
...
pub(crate) fn fill(surface: &mut Surface, rect: IntRect, color: Color) {
    if rect.w > 0 && rect.h > 0 {
        fill_rect(surface, &gui_rect(rect), color);
    }
}

pub(crate) fn draw_bottom_line(surface: &mut Surface, rect: IntRect, color: Color) {
    fill(
        surface,
        IntRect {
            x: rect.x,
...
pub(crate) fn draw_raised(surface: &mut Surface, rect: IntRect, color: Color) {
...
pub(crate) fn draw_sunken(surface: &mut Surface, rect: IntRect, color: Color) {
    fill(surface, rect, color);
    fill(
        surface,
        IntRect {
