...
use clonk_engine::{
    Direction, Engine, COM_CURSOR_RIGHT, COM_DIG, COM_DOWN, COM_LEFT, COM_RIGHT, COM_THROW, COM_UP,
};

fn load_tutorial06() -> (Engine, i32) {
    load_tutorial_with_local_player(6, 0, "Tutorial 6 virtual player", false, true)
}
