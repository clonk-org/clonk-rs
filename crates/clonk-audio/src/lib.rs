...
pub use voice::{
    ...
    VoiceCapture, VoiceCaptureError, VoiceCodecError, VoiceInputFrame, VOICE_CAPTURE_QUEUE_FRAMES,
    VOICE_ENCODED_FRAME_BYTES, VOICE_FRAME_SAMPLES, VOICE_SAMPLE_RATE,
};
