...
crate::support::compile_cases! {
    if_with_space_before_closing_paren: r#"func Test() { var dir; if(dir == GetValue() ) dir = -1; }"#;

// Exact pattern: function call with () followed by space and )
    if_with_double_parens_and_space: r#"func Test() { var x; if(x == Func() ) x = 1; }"#;

// Line 55 pattern: x = y = -1;
    chained_assignment_in_if_body: r#"func Test() { var x, y; if(1) x = y = -1; }"#;
