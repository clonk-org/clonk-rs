...
eval_cases! {
    ...
    division_by_zero_yields_zero_like_cpp:
        "func Test() { return 5 / 0; }" => Value::Int(0);

    // 5 % 0 == 0 (C4AulExec.cpp:526 pPar1->Set0())
    modulo_by_zero_yields_zero_like_cpp:
        "func Test() { return 5 % 0; }" => Value::Int(0);
    division_by_zero_via_variable_yields_zero:
        "func Test() { var d = 0; return 42 / d; }" => Value::Int(0);
    modulo_by_zero_via_variable_yields_zero:
        "func Test() { var d = 0; return 42 % d; }" => Value::Int(0);
}
