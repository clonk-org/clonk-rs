...
crate::support::compile_cases! {
    indi_line_818_pattern: r#"func ControlCommandFinished (string CommandName, object Target, any Tx, int Ty, object Target2, any Data) { }"#;

// func Test(any x)
    any_type_first_param: r#"func Test(any x) { }"#;

// func Test(int x, any y, string z)
    any_type_middle_param: r#"func Test(int x, any y, string z) { }"#;

// func Test(any x, any y)
    multiple_any_params: r#"func Test(any x, any y) { }"#;

// Pattern from JungleClonk, Inuk, Trapper (same as INDI)
    jungle_clonk_pattern: r#"func ControlCommandFinished (string CommandName, object Target, any Tx, int Ty, object Target2, any Data) { return(1); }"#;
}
