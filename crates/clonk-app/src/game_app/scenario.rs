...
//! state. Extracting an independently owned scenario-lifecycle state is
//! tracked by clonk-org/clonk-rs#1244.
...
impl GameApp {
    ...
    pub(crate) fn open_scenario_browser_with_mode(&mut self, selector_mode: ScenarioSelectorMode) {
        ...
        // Every game option is an in-memory `Config` field that the netdlg and
