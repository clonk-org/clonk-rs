...
use clonk_frontend::{
    ...
    GuiPoint, HudGraphics, ImageData, InputDispatcher, InventoryOverlay, KeyCode, LazyImage,
    MainMenuAction, MainMenuItem, MaterialRenderInfo, MaterialTextureSurface, MessageBoardMode,
            ...
            match event {
                ...
                Event::AboutToWait => {
                    ...
                    if app.sync_developer_console_view() {
                        window.set_title(&app.developer.console.view_model().caption);
...
impl GameApp {
    ...
    fn new_with_frontend_scenarios_for_profile(
        ...
        let mut app = Self {
            ...
            console_viewports: ConsoleViewportState {
                scroll_drag: None,
                projections: Default::default(),
                context_menu: None,
                context_menu_grab: None,
            },
            developer: DeveloperToolsState {
                console: DeveloperConsole::new(),
                console_edit_mode: ConsoleEditMode::Play,
                selection: Default::default(),
                tools: Default::default(),
                tools_open_combo: None,
                object_list_scroll: Default::default(),
                pane_scroll_drag: None,
                object_list_cursor: None,
                object_list_anchor: None,
                object_tree_expansion: Default::default(),
                object_list_revealed: None,
                property_script_input: String::new(),
                property_scroll: Default::default(),
                toolbox: Default::default(),
                toolbox_effects: Vec::new(),
                object_list_open: false,
                component_editor: None,
                component_hosts: Vec::new(),
                console_editing_enabled: true,
                console_pointer: GuiPoint::new(0.0, 0.0),
            },
    ...
    fn timestamp_log_line(&self, line: String) -> String {
        if self.chat.show_log_timestamps {
            format!(
                "{} {line}",
