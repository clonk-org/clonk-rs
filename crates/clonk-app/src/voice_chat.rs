...
//! summed voice bus to its own ceiling and the remaining output headroom.
//! Audible received speech gently lowers music while it plays; game effects
//! and music outside conversations retain SDL_mixer's arithmetic.
