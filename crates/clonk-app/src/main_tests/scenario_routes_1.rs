...
fn real_alchemy_control_right_drag_puts_carryable_into_hut(
    ...
    main_assert_eq!(app.input_routing.live.ingame_mouse_target => Some(bag));
    app.test_right_button(ElementState::Pressed);
    app.test_cursor(PhysicalPosition::new(
    ...
    main_assert_eq!(app.input_routing.live.ingame_mouse_target => Some(hut));
    app.test_right_button(ElementState::Released);
...
fn real_alchemy_left_double_click_gets_carryable_like_cpp_mouse_control(
    ...
    let click_world = ingame_pointer_world_pixel(app.input_routing.live.ingame_pointer.test_value());
...
fn tutorial09_real_temporary_breath_physical_renders_the_cpp_hud_bar(
    ...
    let overlays = {
        ...
        collect_player_overlays(
            ...
            Some(clonk),
            &game_app.bindings,
            &game_app.input_routing.gamepad_bindings,
        )
    };
    let crew = overlays
        .iter()
