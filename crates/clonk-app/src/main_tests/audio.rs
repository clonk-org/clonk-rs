...
fn focus_loss_clears_controls_repeat_tracking_and_pointer_state() {
    ...
    app.input_routing.live.ingame_pointer = Some(ViewportPointer {
    ...
    main_assert_eq!(app.input_routing.live.ingame_pointer => None, "focus loss retains the old pointer_left lifecycle cleanup");
}
