...
fn help_right_up_exits_without_context_or_crew_cycle() {
    ...
    for release in [point, empty] {
        ...
        app.test_right_button(ElementState::Pressed);
        main_assert!(app.input_routing.live.ingame_mouse_help, "right-down retains Help");
        app.test_right_button(ElementState::Released);
        main_assert!(!app.input_routing.live.ingame_mouse_help, "right-up exits Help");
...
fn ownerless_mouse_viewport_buttons_remain_local_and_open_fullscreen_menu() {
    ...
    app.test_left_button(ElementState::Pressed);
    main_assert!(!app.input_routing.live.ingame_mouse_help, "passive buttons wait for LeftUp");
    app.test_left_button(ElementState::Released);
    main_assert!(app.input_routing.live.ingame_mouse_help);
    ...
    app.test_right_button(ElementState::Pressed);
    main_assert!(app.input_routing.live.ingame_mouse_help, "right-down retains passive Help");
    app.test_right_button(ElementState::Released);
    main_assert!(!app.input_routing.live.ingame_mouse_help, "right-up exits passive Help");
...
fn running_gui_ownership_matches_cpp_reset_and_dialog_lifetime() {
    ...
    main_assert!(app.input_routing.live.gui_mouse_owned, "C4MouseControl reset must not deactivate C4GUI::CMouse");
    main_assert!(app.input_routing.live.world_mouse_owned, "C4MouseControl::Default independently restores fMouseOwned");
    ...
    main_assert!(!app.input_routing.live.gui_mouse_owned);
    main_assert!(app.input_routing.live.world_mouse_owned);
    main_assert!(app.input_routing.live.ingame_pointer.is_some(), "the independently reinitialized world pointer remains active");
    main_assert_eq!(app.input_routing.live.ingame_pointer => Some(reset_world_pointer));
    ...
    app.test_render(&mut frame);
    main_assert!(app.input_routing.live.gui_mouse_owned, "a shown C4Menu remains a C4GUI owner when viewport pixels are suppressed");
    main_assert!(!app.input_routing.live.world_mouse_owned);
...
fn global_gui_guard_is_first_at_every_external_ui_ingress() {
    ...
    main_assert_eq!(app.input_routing.live.modifiers => modifiers);
    let surface = app.rendering.graphics.surface();
