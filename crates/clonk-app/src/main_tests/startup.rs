...
// sequence, not a child module, so test ids stay `tests::<fn>`.
    ...
    fn startup_fullscreen_title_tooltips_follow_active_language_amp_rules() {
        ...
        let net_metrics =
            clonk_frontend::startup_netdlg::NetDlgFontMetrics::from_fonts(fonts.as_ref());
        ...
        let scenario =
            clonk_frontend::startup_scensel::scen_sel_layout(640, 480, fonts.as_ref());
        assert_eq!(
    ...
    fn assigned_mouse_viewport_routes_only_its_player_main_menu_clicks() {
        ...
        app.engine
            .replace_player_viewports(
                secondary,
                vec![
                    clonk_engine::PlayerViewport::new(secondary_position)
