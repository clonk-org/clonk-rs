...
pub(crate) fn handle_console_scoreboard_event(
    ...
    match event {
        ...
        Event::WindowEvent {
            ...
            if let Some(legacy) =
                crate::legacy_virtual_key_from_event(key_event, app.input_routing.live.modifiers)
            {
...
pub(crate) fn handle_developer_toolbox_event(
    ...
    match event {
        ...
        Event::WindowEvent {
            ...
            let claimed =
                match crate::legacy_virtual_key_from_event(input, app.input_routing.live.modifiers)
                {
