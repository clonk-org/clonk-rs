...
# The four-core hosted runner builds the final app faster without LTO; Cargo's
# release-profile override below applies that measured choice only to MSVC.
...
rustflags='-Ctarget-feature=+crt-static -Clinker-flavor=lld-link'
