...
- Finish client loading before acknowledging lobby starts (#1816)
- Keep a refused lobby player join from ending the process (#1814)
- Hold the host's synchronized tick until its runtime-join dynamic publishes (#1813)
...
- Reuse script frames and share callback state (#1642)

## [0.27.3] - 2026-09-17

### Bug fixes

- Skip letterless keys and repeated sections when loading config (#1638)
- Preserve native-compiled material reaction strings (#1636)

## [0.27.2] - 2026-09-13

### Performance

- Reduce script callback context overhead (#1631)

## [0.27.1] - 2026-09-12

### Bug fixes

- Present the Clonk Rust product name instead of LegacyClonk (#1627)

### Performance

- Reduce native object query overhead (#1628)
- Reduce script reference and host bookkeeping (#1626)
- Eliminate the C4Script AST fallback interpreter (#1625)
...
- Resume script and native callbacks across section switches (#1516)
...
- Pin GIDL race crew survival across map selection (#1478)
...
- Preserve section transition ordering (#1396)
