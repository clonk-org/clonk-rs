...
fn feedback_engine() -> (Engine, lc_engine::ObjectId, tempfile::TempDir) {
...
fn place(engine: &mut Engine, caller: lc_engine::ObjectId, id: &str, x: i32, y: i32) -> i32 {
...
fn caller_messages(engine: &Engine, caller: lc_engine::ObjectId) -> Vec<(Vec<String>, u32)> {
    engine
        .snapshot()
        .hud
        .messages
