...
use lc_script::{Engine as ScriptEngine, Value};

#[rustfmt::skip]
pub(crate) const C4_SCRIPT_CONSTANTS: &[(&str, i32)] = &[
    ("C4D_All", 4294967295u32 as i32),
    ("C4D_StaticBack", 1),
    ("C4D_Structure", 2),
    ("C4D_Vehicle", 4),
    ("C4D_Living", 8),
    ...
    ("C4D_Magic", 131072),
    ("C4D_Rule", 524288),
    ("C4D_Background", 1048576),
    ("C4D_Parallax", 2097152),
    ("C4D_MouseSelect", 4194304),
    ("C4D_Foreground", 8388608),
    ("C4D_MouseIgnore", 16777216),
    ("C4D_IgnoreFoW", 33554432),
    ("C4D_GrabGet", 2),
    ("C4D_GrabPut", 1),
    ("C4D_LinePower", 1),
    ("C4D_LineSource", 2),
    ...
    ("C4D_LiquidInput", 4),
    ("C4D_LiquidOutput", 8),
    ("C4D_PowerGenerator", 16),
    ("C4D_PowerConsumer", 32),
    ("C4D_LiquidPump", 64),
    ...
    ("OCF_HitSpeed2", 4096),
    ("OCF_HitSpeed3", 8192),
    ("OCF_Collection", 16384),
    ("OCF_Living", 32768),
    ("OCF_HitSpeed4", 65536),
    ("OCF_FightReady", 131072),
    ("OCF_LineConstruct", 262144),
    ("OCF_Prey", 524288),
    ("OCF_AttractLightning", 1048576),
    ("OCF_NotContained", 2097152),
    ("OCF_CrewMember", 4194304),
    ("OCF_Edible", 8388608),
    ("OCF_InLiquid", 16777216),
    ("OCF_InSolid", 33554432),
    ("OCF_InFree", 67108864),
    ("OCF_Available", 134217728),
    ("OCF_PowerConsumer", 268435456),
    ("OCF_PowerSupply", 536870912),
    ("OCF_Container", 1073741824),
    ("OCF_Alive", 2147483648u32 as i32),
    ("VIS_All", 0),
    ("VIS_None", 1),
    ("VIS_Owner", 2),
    ("VIS_Allies", 4),
    ...
    ("FX_Effect_Deny", -1),
    ("FX_Effect_Annul", -2),
    ("FX_Effect_AnnulDoCalls", -3),
    ("FX_Execute_Kill", -1),
    ("FX_Stop_Deny", -1),
    ("FX_Start_Deny", -1),
    ("FX_Call_Normal", 0),
    ("FX_Call_Temp", 1),
    ("FX_Call_TempAddForRemoval", 2),
    ("FX_Call_RemoveClear", 3),
    ("FX_Call_RemoveDeath", 4),
    ("FX_Call_DmgScript", 0),
    ("FX_Call_DmgBlast", 1),
    ("FX_Call_DmgFire", 2),
    ("FX_Call_DmgChop", 3),
    ("FX_Call_Energy", 32),
    ("FX_Call_EngScript", 32),
    ("FX_Call_EngBlast", 33),
    ("FX_Call_EngObjHit", 34),
    ("FX_Call_EngFire", 35),
    ("FX_Call_EngBaseRefresh", 36),
    ("FX_Call_EngAsphyxiation", 37),
    ("FX_Call_EngCorrosion", 38),
    ("FX_Call_EngStruct", 39),
    ("FX_Call_EngGetPunched", 40),
    ("GFXOV_MODE_None", 0),
    ("GFXOV_MODE_Base", 1),
    ("GFXOV_MODE_Action", 2),
    ("GFXOV_MODE_Picture", 3),
    ("GFXOV_MODE_IngamePicture", 4),
    ("GFXOV_MODE_Object", 5),
    ("GFXOV_MODE_ExtraGraphics", 6),
    ("GFX_Overlay", 1),
    ("GFXOV_Clothing", 1000),
    ("GFXOV_Tools", 2000),
    ("GFXOV_ProcessTarget", 3000),
    ("GFXOV_Misc", 5000),
    ("GFXOV_UI", 6000),
    ("GFX_BLIT_Additive", 1),
    ("GFX_BLIT_Mod2", 2),
    ("GFX_BLIT_ClrSfc_OwnClr", 4),
    ("GFX_BLIT_ClrSfc_Mod2", 8),
    ("GFX_BLIT_Custom", 128),
    ("GFX_BLIT_Parent", 256),
    ("NO_OWNER", -1),
    ("CNAT_None", 0),
    ...
    ("C4MSGCMDR_Escaped", 0),
    ("C4MSGCMDR_Plain", 1),
    ("C4MSGCMDR_Identifier", 2),
    ("BASEFUNC_Default", 65535),
    ("BASEFUNC_AutoSellContents", 1),
    ("BASEFUNC_RegenerateEnergy", 2),
    ("BASEFUNC_Buy", 4),
    ("BASEFUNC_Sell", 8),
    ("BASEFUNC_RejectEntrance", 16),
    ("BASEFUNC_Extinguish", 32),
    ("C4FO_Not", 1),
    ("C4FO_And", 2),
    ("C4FO_Or", 3),
    ("C4FO_Exclude", 5),
    ...
    ("C4CMD_Sub", 3),
    ("C4CMD_SilentSub", 0),
    ("C4CMD_MoveTo_NoPosAdjust", 1),
    ("C4CMD_MoveTo_PushTarget", 2),
    ("C4CMD_Enter_PushTarget", 2),
    ...
    ("C4PT_User", 1),
    ("C4PT_Script", 2),
    ("CSPF_FixedAttributes", 1),
    ("CSPF_NoScenarioInit", 2),
    ("CSPF_NoEliminationCheck", 4),
    ("CSPF_Invisible", 8),
    ("RESTORE_None", 0),
    ("RESTORE_ScriptPlayers", 1),
    ("RESTORE_PlayerTeams", 2),
    ("C4PVM_Cursor", 0),
    ("C4PVM_Target", 1),
    ("C4PVM_Scrolling", 2),
];
