...
use lc_resources::{Group, GroupError, MutableGroup, MutableGroupEntryKind, MutableGroupError};
...
impl Engine {
    ...
    pub fn adopt_loaded_c4_string_table(&mut self, values: &[Vec<u8>]) {
        ...
        for (index, value) in values.iter().enumerate() {
            ...
            let value = lc_script::c4_string_from_bytes(value);
            lc_script::register_loaded_c4_string(&registrations, enum_id, &value);
        }
