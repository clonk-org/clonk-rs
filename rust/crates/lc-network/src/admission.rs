...
use lc_engine::{ClientCoreControlData, ClientJoinControlData, LegacyCString};
...
pub enum ConnectionAction {
    ...
    RegisterHost(lc_engine::ClientCoreControlData),
...
pub enum AdmissionDecision {
    Accept {
        peer_core: lc_engine::ClientCoreControlData,
    ...
    pub fn receive_reply(&mut self, reply: ConnectionReply) -> Vec<ConnectionAction> {
        ...
        if !self.conn_sent {
            ...
            return vec![ConnectionAction::Close {
                message: lc_engine::LegacyCString::default(),
                wrong_password: false,
            }];
        }
