...
mod tests {
    ...
    fn malformed_resources_fail_instead_of_falling_back() {
        ...
        let empty_fonts = Arc::new(ClonkFontSet {
            title: lc_graphics::clonk_font::ClonkFont::new(34),
            caption: lc_graphics::clonk_font::ClonkFont::new(25),
            text: lc_graphics::clonk_font::ClonkFont::new(22),
            main_small: lc_graphics::clonk_font::ClonkFont::new(20),
            mini: lc_graphics::clonk_font::ClonkFont::new(18),
        });
        assert_eq!(
