...
pub use crate::vm::{
    caller_origin_strictness, caller_strictness, caller_var_slots, value_cell, CallerVarSlots,
    HostCallArg, HostCallerStrictness, LocalCells, ValueCell, ValueReference,
};
