use lc_network::{NetworkStatus, NETWORK_STATE_GO, NETWORK_STATE_PAUSE};
...
#[cfg(test)]
mod tests {
    use lc_network::{NetworkStatus, NETWORK_STATE_GO, NETWORK_STATE_LOBBY, NETWORK_STATE_PAUSE};
