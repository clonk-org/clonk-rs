...
//!
//! `lc_core::std_config::Config` deliberately preserves an INI document as
...
//! `lc-frontend`. Unknown INI extensions never enter the editor and therefore
...
mod tests {
    use super::*;
    use lc_frontend::startup_options_advanced::AdvancedConfigController;
