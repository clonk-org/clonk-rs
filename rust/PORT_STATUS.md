...
| objects-core | 2026-07-09 OCF epic CLOSED the SetOCF computation gap: all 30 C4Object::SetOCF bits (C4Object.cpp:526-666) now compute — Normal :548, Construct :549-552 (Constructable+Con<FullCon+r==0+!OnFire), Grab :553-555 (Def->Grab, never StaticBack), Carryable :556-558, OnFire :559-561, Inflammable :562-566, FullCon :567-569, Chop :570-575 (Chopable+StaticBack+the AtObject(x,y,OCF_Exclusive) blocker probe), Rotate :576-580 (Con>100), Exclusive :581-583, Entrance :584-587 (area+FullCon+RotatedEntrance gate), HitSpeed1-4 :588-592, Collection :593-599 (FullCon/IncompleteActivity + area + CollectionLimit + !ActMap Disabled + NoCollectDelay==0), Living/Alive :600-605 (C4D_Living category), FightReady :606-610 (Alive bit + !ActMap Disabled + !NoFight), LineConstruct :611-614 (LineConnect&~C4D_EnergyHolder at FullCon), Prey :615-618, CrewMember :619-622, AttractLightning :623-626, NotContained :627-629, Edible :630-632, InLiquid :633-636, InSolid :637-640 (GBackSolid + solid-mask overlay in rect worlds), InFree :641-644, Available :645-648 (container Grab_Get/Entrance clause + the y-1/y-8 burial probe), PowerConsumer :649-652, PowerSupply :653-657 (generator or energized output), Container :658-660. New DefCore ingest: Entrance/RotatedEntrance/Exclusive/Prey/Edible/Chop/AttractLightning/NoFight (C4Def.cpp:309-413) + ActMap ObjectDisabled (C4Def.cpp:106). GetOCFForPos area verification ported into at_object (C4Object.cpp:1131-1160, C4GameObjects.cpp:243-248). Consumers aligned with the C++ cached-mask model: command snapshots and script GetOCF (FnGetOCF C4Script.cpp:1354-1358) read the cached obj->OCF; the preview-grade ocf::compute (creation previews, bare fixture scopes) gates Living/Alive on C4D_Living. OCF REMAINING: SetOCF's InMat update (:543-546, needs Contained->Def->ClosedContainer + GBackMat InMat state — unmodeled); NoCollectDelay is armed nowhere yet (ObjectComDrop sets 2, C4ObjectCom.cpp:668-669, and SetCommand decrements, C4Object.cpp:3939-3940 — both live with the command layer; the DirectCom decrement :3359-3362 IS ported) and is not read from Objects.txt (C4Object.cpp:2773); previews for objects created mid-script-call stay preview-grade until materialization (C++ runs full SetOCF inside CreateObject); C4Object::At lacks the addtop() build-top shape extension (C4Object.h:340, :1125). Older gaps: C4ObjectInfo permanent training/experience unmodeled; DFA_CONNECT uses direct endpoint assignment (the LineConnect wrapping walker is unported) |
