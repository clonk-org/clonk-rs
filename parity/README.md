...
| `network_lobby_status_reach` | complete `C4Network2::CheckStatusReached` (`src/C4Network2.cpp:2017-2057`) | client lobby entry acknowledges Lobby at the current control tick, while Go/Pause wait for initialization; compared by the app's `initial_lobby_status_parity::parity_differential_matches_cpp_golden` test |
