...
# production script-host helper (src/C4ScriptKiller.h), and the production
# coarse landscape traversal (src/C4LandscapePath.h). The Rust side
...
#    C4ScriptKiller.h/C4LandscapePath.h production helpers, and the generated
#    header/table; then run it to produce the golden JSON.
cxx="${CXX:-clang++}"
"$cxx" -std=c++20 -O0 \
  -I"$gen" -I"$src" \
